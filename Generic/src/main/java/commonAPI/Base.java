...
public class Base {
        ...
        //@BeforeMethod
        public void setUp(@Optional("false")Boolean useCloudEnv, @Optional("userName") String userName,@Optional("gdfsd")
        String key, @Optional("Windows 8")String OS,@Optional("firefox") String browser,
                          @Optional("40.0") String browserVersion,
                          @Optional("https://simple-chat-asapp.herokuapp.com/") String url)throws IOException {
